...
INSERT IGNORE INTO servicios (id, name, category, price, duration_minutes, popular, active) VALUES
...
INSERT IGNORE INTO estilistas (id, name, role, specialty, avatar, rating, reviews_count, is_available, shift, completed_today_count) VALUES
...
INSERT IGNORE INTO clientes (id, name, email, phone, avatar, total_visits, total_spent, last_visit, tier, notes) VALUES
...
INSERT IGNORE INTO citas (id, client_id, client_name, client_avatar, service_id, service_name, service_category, stylist_id, stylist_name, date, time, duration_minutes, price, status, notes) VALUES
...
INSERT IGNORE INTO notificaciones (id, title, message, time, `read`, type) VALUES
