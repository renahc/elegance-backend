...
public class ClientEntity {
    ...
    public ClientEntity(String id, String name, String email, String phone, String avatar, 
                       Integer totalVisits, Integer totalSpent, String lastVisit, String tier, String notes) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.phone = phone;
